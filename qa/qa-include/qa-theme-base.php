...
*/
	...
	*/
	...
	//	search() outputs <div class="qa-search">, q_list() outputs <div class="qa-q-list">, etc...
		...
		function logged_in()
		{
			//$this->output('<div class="qa-logged-in"><span class="qa-logged-in-pad">Hello </span><span class="qa-logged-in-data"><a class="qa-user-link" href="/qa/index.php/user/ormikopo1988">ormikopo1988</a></span></div>');
		...
		function footer()
		{
			...
			$this->nav('footer');
			$this->output('<div align="right"><a class="qa-nav-footer-link" target="_blank" href="http://ireteth.certh.gr">© 2015 - I.RE.TE.TH.</a><div>');
			$this->footer_clear();
